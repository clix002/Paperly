...
const KANBAN_COLUMNS: KanbanColumn[] = [
  {
    ...
    laneBg: "bg-blue-50/80",
    emptyBorder: "border-blue-200/40",
  },
  {
    status: DocumentStatus.Viewed,
    label: "Vistos",
    headerBadge: "bg-violet-500 text-white",
    laneBg: "bg-violet-50/80",
...
function KanbanCard({ doc, isSelected, onSelect }: KanbanCardProps) {
  ...
  return (
    <button
      type="button"
      className={cn(
        "w-full text-left rounded-lg border bg-white/90 p-2.5 transition-all",
        "hover:bg-white hover:shadow-sm",
        isSelected ? "ring-2 ring-primary shadow-sm bg-white" : "border-border/40"
      )}
