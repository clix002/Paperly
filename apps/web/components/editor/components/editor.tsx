...
export const Editor = ({
  ...
  const canvasBgRef = useRef(resolvedTheme === "dark" ? "#262626" : "#e5e5e5")

  useEffect(() => {
    canvasBgRef.current = resolvedTheme === "dark" ? "#262626" : "#e5e5e5"
    const canvas = fabricCanvasRef.current
    if (canvas) {
      canvas.backgroundColor = canvasBgRef.current
    ...
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex flex-1 flex-col overflow-hidden">
          {!isWorker && <Toolbar {...sidebarProps} />}
          <div className="relative flex-1 min-h-0">
            <div
              className="absolute inset-0 overflow-auto bg-neutral-100 dark:bg-neutral-900"
              ref={containerRef}
            >
